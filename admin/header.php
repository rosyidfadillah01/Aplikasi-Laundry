...
<head>
    ...
    <?php
        if (isset($_SESSION['login_success']) && $_SESSION['login_success'] == true) {
            ...
            unset($_SESSION['login_success']); // Hapus session agar alert tidak muncul lagi
        }
    ?>
    <!-- CSS Files -->
        ...
        <div class="main-header">
            ...
            <div class="logo-header" data-background-color="dark">
                ...
                <a href="index.html" class="logo">
                    <img src="../assets/img/logo.png" width="150px" alt="navbar brand" class="navbar-brand img-fluid">
                </a>
